...
public class miniprojecteS1 {
	...
	private String getInformacio(File file) {
		...
		String mostrar = ("Nom: " + nombre + " Tipus: " + tipus + " Ruta:" + ubicacio + "\nUltima modificació: "
				+ fechaUltimaModificacion + " Ocult: " + ocult);
		return mostrar;
		// • Mostrar el nom, tipus (si es fitxer o directori), la ubicació (ruta
		...
		// • Si és un directori haurà de mostrar el nombre d’elements que
	...
	private void renomena() {
		// Renomena fitxers/carpetes
	}
}
